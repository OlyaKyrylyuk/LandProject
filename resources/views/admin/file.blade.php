    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/') }}">Головна
                </a>
            </div>
        ...
        <div class="menuadmin">
            <nav class="dws-menu">
                <ul>
                    ...
                    <li><a href="/admin/notifications"><i class="fa fa-bell" aria-hidden="true"></i><span class="badge badge-light">{{$deals_tommorow}}</span></a></li>
                </ul>
            </nav>
        </div>
