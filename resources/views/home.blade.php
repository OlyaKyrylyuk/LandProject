...
@if(Auth::user()->role=='admin')
    <script>window.location.href = 'http://localhost:8000/admin/home';</script>
                ...
                <div class="block_container">
                    ...
                    <div class="bloc1">
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('insert_claim') }}">
                            {{ csrf_field() }}
                            <div>
                            <h1 class="num_h1">Форма заповнення заяви</h1><br></div>
                            <textarea id="reason" name="reason"  class="form"  placeholder="Введіть скаргу для заповнення заяви"></textarea><br>
                        ...
                        <form class="form-horizontal" method="POST" action="{{ url('send_email') }}">
                            {{ csrf_field() }}
                            <div><h1 class="num_h1">Відправлення повідомлення стосовно справи</h1><br></div>
                            <textarea id="gmail" name="gmail"  class="form"  placeholder="Відправити на пошту"></textarea><br>
                            <button type="submit" class="btn btn-primary">
